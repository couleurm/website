...
export default function Card({title, description, href, color}: {
    ...
    const content = (
      <div className="p-5 flex items-center justify-center bg-gray-200 dark:bg-gray-space-gray rounded-md flex-1 ring-gray-300 dark:ring-gray-900 hover:bg-gray-100 hover:ring-2 transition-all">
        <div
